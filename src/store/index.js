  ...
  state: {
    chiropractors: [
      {
        ...
        experience: "20",
        location: "Ankeny",
        focus: "State of the art chiropractic techniques",
        services: ["Chiropractic care", "Non-surgical spinal decompression"],
        picture: "dr-christopher-renze-renze-chiropractic.jpg",
        contactUrl: "https://www.renzechiro.com/contact/",
        businessName: "Renze Chiropractic",
        websiteUrl: "https://www.renzechiro.com/",
        education: "Dr. Renze completed his Doctor of Chiropractic in 2002 at Palmer College of Chiropractic. He also completed a rigorous three-year post-graduate specialty program in Clinical Neurology. Dr. Renze has been Board-Certified as a Chiropractic Neurologist since 2007.",
        specialization: "We provide advanced spinal correction utilizing 'state of the art' chiropractic techniques. Never in the history of chiropractic have we been able to provide the level of help and expertise that now exists. These newer correction methods are even safer, more comfortable and more effective than ever before. As a Doctor of Chiropractic, Dr. Christopher Renze has years of training and experience in spinal adjustments.",
        about: "Dr. Renze has extensive clinical, educational, and instructional experience in Chiropractic. His licensure includes the International Academy of Clinical Neurology (2007), the State of Iowa (License 06501, 2002), and the National Boards Parts I, II, III, IV, and Physiotherapy (2002).",
        extras: "Our comprehensive Non-Surgical Spinal Decompression program offered through our SpinalAid Center is second to none. We are the only Certified SpinalAid Decompression Center in Central Iowa offering this revolutionary technology. To learn more about this program please visit www.spinemed.com. We offer a free consultation to review your case to see if you are a candidate for this procedure. If interested, please call (515) 965-3844 to schedule this appointment.",
      }
    ],
    navLinks: [
      {
    ...
    infoCards: [
      ...
      },
      {
        ...
        text: "Spinal manipulation is the most common form of treatment utilized in chiropractic care. A variety of techniques can help you on your way to a life with less pain and more freedom.",
    ...
    rightCards: [
      {
        ...
        text: "This online directory features a plethora of licensed chiropractic practices spread all over the Ankeny metro area. No matter where you live in Central Iowa, the right local practice is not too far away and ready to offer treatment."
      },
      {
        id: 2,
        caption: "The Right Chiropractor",
        text: "With so many options in the Ankeny metro area, it will not be difficult to find the right chiropractor for you and your needs. Just take a look through our directory to find the professional and the treatment that is right for you."
      }
    ],
    listingBenefits: [
      {
    ...
    blogPosts: [
      {
        ...
        postImage: "5-reasons-your-business-should-be-listed-in-an-online-directory.jpg",
        postImageUrl: "https://www.ankenychiropractors.com/img/5-reasons-…uld-be-listed-in-an-online-directory.8fd6d9ea.jpg",
      ...
      },
      {
        ...
        postImage: "3-simple-ways-to-grow-your-chiropractor-business-online.jpg",
        postImageUrl: "https://www.ankenychiropractors.com/img/3-simple-w…ow-your-chiropractor-business-online.62e07f78.jpg",
      ...
      },
      {
        ...
        postImageUrl: "https://www.ankenychiropractors.com/img/netlify-logo.0e6a1002.svg",
      ...
      },
      {
        ...
        authorCompany: "Design for Chiropractors LLC",
        authorImage: "cody-eklov.png",
        postLink: "top-standard-color-schemes-for-website-design",
        postTitle: "Top Standard Color Schemes for Website Design",
        postImage: "top-standard-color-schemes-for-website-design.jpg",
        postImageUrl: "https://www.ankenychiropractors.com/img/top-standard-color-schemes-for-website-design.06fce2fc.jpg",
        postImageAlt: "Several crayon-shaped pieces of chaulk in different colors",
        postSnippet: "Colors are important for website design and marketing your business. A number of color schemes are popular because they are effective and reinforce brand image.",
        postContents: "<p class='mb-4 leading-relaxed'>Some of the best branding and designing often goes unnoticed--not because it is done poorly, but because it is done <em>well</em>. It is worth taking a closer look at some color schemes popular in website design, precisely because they can be so important and effective.</p><h2 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>Why Colors Are Important</h2><p class='mb-4 leading-relaxed'>A good color scheme is pleasing to the eyes and attractive to viewers. This much is obvious.</p><p class='mb-4 leading-relaxed'>But a <em>great</em> color scheme also does so much more. An effective color scheme <strong>reinforces company image</strong> and <strong>evokes certain emotions</strong> in the viewer.</p><p class='mb-4 leading-relaxed'>So, let's briefly discuss some commonly utilized color schemes for website design.</p><h2 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>Standard Color Schemes</h2><p class='mb-4 leading-relaxed'>Among the most common color schemes prevalent on the Internet include: blue, green, and a combination of black, white, and grey.</p><h3 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>Blue</h3><p class='mb-4 leading-relaxed'>Blue color schemes are very common in modern website design. Shades of blue and its complementary colors tend to evoke <strong>feelings of trust and calm</strong>. Blues can also promote a <strong>feeling of higher intellect and authority</strong>.</p><p class='mb-4 leading-relaxed'>So, the emotions that blue color schemes evoke lend themselves well to businesses where calm and trust are desired, such as healthcare, finances, and technology.</p><p class='mb-4 leading-relaxed'>Here are a few examples of some websites using a blue color scheme:</p><ul class='list-disc'><li class='mb-4 ml-6 leading-6'><a href='https://zoom.us/' target='_blank'>Zoom</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.americanexpress.com/' target='_blank'>American Express</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.walmart.com/' target='_blank'>Walmart</a></li></ul><h3 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>Green</h3><p class='mb-4 leading-relaxed'>Green color schemes often evoke <strong>feelings of being natural and healthy</strong>. They also naturally make us think of <strong>finances and money</strong>.</p><p class='mb-4 leading-relaxed'>Green color schemes are therefore appropriate for business involved in finances, foods (especially natural and organic), and health.</p><p class='mb-4 leading-relaxed'>Here are a few examples of some websites using a green color scheme:</p><ul class='list-disc'><li class='mb-4 ml-6 leading-6'><a href='https://mint.intuit.com/' target='_blank'>Mint</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.shopify.com/' target='_blank'>Shopify</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.instacart.com/' target='_blank'>Instacart</a></li></ul><h3 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>Black, White, and Gray</h3><p class='mb-4 leading-relaxed'>Another standard color scheme is a combination of black, white, and gray. These colors often imbue the viewer with <strong>feelings of being classy and sophisticated</strong>.</p><p class='mb-4 leading-relaxed'>Black, white, and gray color schemes are great for authoritative and up-scale branding. These colors support a company image of being modern, fancy, high-quality, expensive (or more nicely put, valuable), and chic.</p><p class='mb-4 leading-relaxed'>Here are a few examples of some websites using black, white, and gray color schemes:</p><ul class='list-disc'><li class='mb-4 ml-6 leading-6'><a href='https://www.apple.com/' target='_blank'>Apple</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.verizon.com/' target='_blank'>Verizon</a></li><li class='mb-4 ml-6 leading-6'><a href='https://www.nike.com/' target='_blank'>Nike</a></li></ul><h2 class='text-xl lg:text-2xl mt-12 mb-4 text-gray-600'>What Are Your Colors?</h2><p class='mb-4 leading-relaxed'>Given all we've discussed, what are your colors? What is the color scheme that supports your brand? Which colors will evoke the desired emotions in your website's visitors?</p><p class='mb-4 leading-relaxed'>Think about it. It's important.</p>",
        postDate: new Date("2022/04/04"),
        lastUpdateDate: null,
        postCategory: "Web Design",
        postOrigin: "https://www.designforchiropractors.com/blog/top-standard-color-schemes-for-website-design/"
      }
    ],
    metaLogoImage: "https://www.ankenychiropractors.com/img/ankeny-chiropractors.fc3aba92.jpg",
