    ...
    chiropractors: [
      {
        ...
        experience: "",
        location: "Inner Space Des Moines",
        focus: "Healing of the body, mind, and spirit",
        services: ["Chiropractic adjustments", "Energy healing modalities"],
        picture: "dr-rebecca-lake-shine-chiropractic.jpg",
        contactUrl: "https://rebeccalakedc.com/contact-us",
        businessName: "Shine Chiropractic and Wellness",
        websiteUrl: "https://rebeccalakedc.com/",
        education: "Dr. Rebecca is a graduate of Palmer College of Chiropractic in Davenport, IA.",
        specialization: "Dr. Rebecca firmly believes that we have all had huge or small traumas in our lives that get stored within our bodies and that they can manifest emotionally, physically, and mentally. What we think, put in our bodies, or the traumas that we face can cause nervous system interference or misalignments of the spine.",
        about: "Dr. Rebecca Lake, D.C. serves the greater Des Moines community as an intuitive chiropractor. A native of Rock Island, IL, and a graduate of Palmer College of Chiropractic in Davenport, IA. Dr. Lake utilizes a unique blend of chiropractic adjustments and energy healing modalities to facilitate healing of the body, mind, and spirit.",
        extras: "When Dr. Rebecca isn't in the office seeing patients, you can usually find her practicing on her yoga mat practicing yoga, meditating, or doing breathwork. She also loves daily journaling, digging into a good book whether it be fiction or even self-help. You can also find her some summer weekends slinging craft beers at Confluence Brewing Company.  Dr. Rebecca loves supporting other small businesses and loves shopping locally in our community.",
      }
    ],
    navLinks: [
      {
