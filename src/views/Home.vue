  ...
  >
    ...
    >
      <p class="p-8 text-gray-700">
        Chiropractic care has helped countless people manage pain and improve
        their general health. It is typically less invasive and less expensive
    ...
    >
      <p class="p-8 text-gray-700">
        Spinal adjustments are the most common form of treatment utilized in
        chiropractic care. A variety of techniques can help you on your way to a
      ...
      >
        ...
        <h2 class="font-semibold text-lg lg:text-xl">Spinal Manipulation</h2>
      </div>
    </div>
    ...
    >
      <p class="p-8 text-gray-700">
        Treatment by a licensed professional can both help heal current injuries
        and prevent future ones. Athletes and office workers alike can
      ...
      >
        ...
        <h2 class="font-semibold text-lg lg:text-xl">Injury Prevention</h2>
      </div>
    </div>
  </section>
      ...
      <div class="flex flex-col lg:mx-8 lg:flex-row mb-20 lg:mb-0">
        <div class="w-full mt-8 lg:mt-0">
          ...
          <p class="text-gray-600 leading-loose mb-6">
            This online directory features a plethora of licensed chiropractic
            practices spread all over the Des Moines metro area. No matter where
            you live in Central Iowa, the right local practice is not too far
            away and ready to offer treatment.
          </p>
          <svg
            class="fill-current h-10 w-10 text-gray-600"
            width="30"
          ...
          <p class="text-gray-600 leading-loose mb-6">
            With so many options in the Des Moines metro area, it will not be
            difficult to find the right chiropractor for you and your needs.
            Just take a look through our directory to find the professional and
