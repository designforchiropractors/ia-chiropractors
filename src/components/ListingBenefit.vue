<template>
    <div class="flex">
        <div class="flex-shrink-0">
            <div class="flex justify-center h-8 md:h-12 w-8 md:w-12 rounded-md text-white">
                <svg class="fill-current text-green-700 mt-1" width="24" height="18" viewBox="0 0 24 18"
